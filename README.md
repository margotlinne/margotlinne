...
- 🎮 SI 회사에서 유니티 개발자로 근무 중 (2024년 7월~), 코딩과 디자인을 모두 담당하는 인디 게임 개발자
...
- 📚 4년간 Unity와 Godot(모두 독학)을 활용한 회사 및 개인 프로젝트 개발 경험
  ...
  - 👤 JSON 기반 게임 저장/불러오기 시스템 구현
  
  - 👤 Love2D 프레임워크(Lua)로 게임 엔진 없이 간단한 카드 짝 맞추기 게임 개발
  
  - 👤 디자인, 프로그래밍, UI, 사운드까지 혼자서 전체 개발을 진행한 개인 프로젝트 다수 보유
  
- 💡 현재 진행 중인 활동:
  
  - 올해 초 4개월간 집중 공부 후 정보처리기사 시험 응시 → 6월 13일 결과 발표 예정
  
  - 토익 공부 중
  
  - Unity3D 기반 턴제 게임 개발 및 응용프로그램 개발 중
