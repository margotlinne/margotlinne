...
- 🎓 컴퓨터공학 전공 (2024년 2월 졸업, GPA 3.65/4.5) | IMAGINE EDUCATION BRISBANE(🇦🇺) - Advanced Class 수료 (2022, 2달 간) | 정보처리기사 자격증 보유 (2025.6)
  
- 🎮 SI 회사에서 유니티 개발자로 근무 중 (2024년 7월~), 싱글 인디 게임 개발자
  
- 🛠 클린 코드와 엔드 투 엔드 시스템 개발을 즐기며, 구조적인 사고와 신뢰할 수 있는 결과를 중요하게 여기는 성장 중인 개발자

- 💼 총 파트타임 경력: 5년 4개월
  
- 📚 4년간 Unity와 Godot(모두 독학)을 활용한 회사 및 개인 프로젝트 개발 경험
  
  - 🏢 모바일 게임 개발 및 출시(Android/iOS)
  
  - 🏢 WebGL 플랫폼 기반의 실시간 멀티플레이 구현(Node.js, Socket.io)

  - 🏢 Meta Horizon Worlds를 통한 XR 콘텐츠 개발 및 퍼블리싱
...
###### 제가 제작한 모든 게임을 <a href="https://github.com/margotlinne/AllGameBy_margotlinne/blob/main/README.md">여기</a>서 확인하세요.
